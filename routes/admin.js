...
router.get("/categories/delete/:slug", isAuth, adminController.categories_delete_get); 
...
router.get("/categories/create", isAuth, adminController.categories_create_get);  

router.post("/categories/create", isAuth, adminController.categories_create_post); 

router.get("/categories/:slug", isAuth, adminController.categories_edit_get); 
...
router.get("/blog/delete/:slug", isAuth, adminController.blog_delete_get); 
...
router.get("/blogs/:slug", isAuth, adminController.blog_edit_get); 
