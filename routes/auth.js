...
router.post("/register", csrf, authController.register_post);

router.get("/login", csrf, authController.login_get);

router.post("/login", csrf, authController.login_post);

router.get("/logout", csrf, authController.logout_get);

router.get("/reset-password", csrf, authController.reset_get);

router.post("/reset-password", csrf, authController.reset_post);

router.get("/new-password/:token", csrf, authController.newpassword_get);

router.post("/new-password", csrf, authController.newpassword_post);
